...
class real_sampling_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "real_sasmpling_2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("real_sasmpling_2")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "real_sampling_2")
        ...
        # Variables
        ##################################################
        self.tone_freq = tone_freq = 10
        self.samp_rate = samp_rate = 40000000
        self.lo_freq = lo_freq = 9.8
        ...
        self._tone_freq_tool_bar.addWidget(Qt.QLabel("Tone Frequency (MHz)" + ": "))
        ...
        self.tab.addTab(self.tab_widget_0, 'Input RF signal')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, 'IF signal')
        self.tab_widget_2 = Qt.QWidget()
        self.tab_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_2)
        self.tab_grid_layout_2 = Qt.QGridLayout()
        self.tab_layout_2.addLayout(self.tab_grid_layout_2)
        self.tab.addTab(self.tab_widget_2, 'ADC output')
        self.top_layout.addWidget(self.tab)
        self._lo_freq_tool_bar = Qt.QToolBar(self)
        self._lo_freq_tool_bar.addWidget(Qt.QLabel("Local oscillator (LO) frequency (MHz)" + ": "))
        self._lo_freq_line_edit = Qt.QLineEdit(str(self.lo_freq))
        self._lo_freq_tool_bar.addWidget(self._lo_freq_line_edit)
        self._lo_freq_line_edit.editingFinished.connect(
            lambda: self.set_lo_freq(eng_notation.str_to_num(str(self._lo_freq_line_edit.text()))))
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(1, samp_rate, .5e6, 100e3, window.WIN_HAMMING, 6.76), 1)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_keep_one_in_n_0 = blocks.keep_one_in_n(gr.sizeof_float*1, 40)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, (lo_freq*1e6), 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, (tone_freq*1e6), 1, 0, 0)
        ...
        self.connect((self.blocks_keep_one_in_n_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.blocks_keep_one_in_n_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.qtgui_time_sink_x_0_0, 1))
    ...
    def set_tone_freq(self, tone_freq):
        ...
        self.analog_sig_source_x_0.set_frequency((self.tone_freq*1e6))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, .5e6, 100e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_freq_sink_x_0_0_0.set_frequency_range(0, (self.samp_rate/40))
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_0_0_0.set_samp_rate(self.samp_rate/40)
    ...
    def set_lo_freq(self, lo_freq):
        ...
        Qt.QMetaObject.invokeMethod(self._lo_freq_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.lo_freq)))
        self.analog_sig_source_x_1.set_frequency((self.lo_freq*1e6))




def main(top_block_cls=real_sampling_2, options=None):
