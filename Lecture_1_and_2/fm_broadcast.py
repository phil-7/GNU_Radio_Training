...
class fm_broadcast(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_station_options = [99100000.0, 99900000.0]
        # Create the labels list
        self._fm_station_labels = ['Country', 'Pop']
        ...
        self.soapy_custom_source_0.set_antenna(0, 'LNAL')
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
