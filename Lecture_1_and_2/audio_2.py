...
class audio_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "audio_2")
        ...
        self._amplitude_line_edit.editingFinished.connect(
            lambda: self.set_amplitude(int(str(self._amplitude_line_edit.text()))))
        self.top_layout.addWidget(self._amplitude_tool_bar)
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            (round(samp_rate*0.1)), #size
            samp_rate, #samp_rate
            "", #name
            1, #number of inputs
            None # parent
    ...
    def set_amplitude(self, amplitude):
        ...
        Qt.QMetaObject.invokeMethod(self._amplitude_line_edit, "setText", Qt.Q_ARG("QString", str(self.amplitude)))
        self.analog_sig_source_x_0.set_amplitude(self.amplitude)




def main(top_block_cls=audio_2, options=None):
