...
class doppler_drift(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "doppler_drift")
        ...
        self.drift_duration = drift_duration = 1000
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, (1 / (drift_duration)), (drift_rate * drift_duration), 0, (-np.pi))
    ...
    def set_drift_rate(self, drift_rate):
        ...
        self.analog_sig_source_x_0.set_amplitude((self.drift_rate * self.drift_duration))
    ...
    def set_drift_duration(self, drift_duration):
        ...
        self.analog_sig_source_x_0.set_frequency((1 / (self.drift_duration)))
        self.analog_sig_source_x_0.set_amplitude((self.drift_rate * self.drift_duration))




def main(top_block_cls=doppler_drift, options=None):
